...
for key, detectionBinList in detectionBinListDict.items():
    ...
    with open(f"{GetRootPath()}/Data/NeuralNetworks/DatasetList_RPLS_VariableInputs/{key}.pkl", "wb") as filehandler:
    ...
    with open(f"{GetRootPath()}/Data/NeuralNetworks/LogStandardScalers_RPLS_VariableInputs/{key}.pkl", "wb") as filehandler:
